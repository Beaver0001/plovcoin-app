...
export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-24 text-rice-soft">
      <h1 className="mb-8 text-3xl font-bold text-rice">Terms of Use</h1>
      <div className="space-y-5 text-sm leading-relaxed">
        <p>PlovCoin ($PLOV) is a cultural memecoin on Solana created for community and entertainment purposes. It is not an investment product, security, or financial instrument, and it confers no rights to profit, governance of any legal entity, or claims against any party.</p>
