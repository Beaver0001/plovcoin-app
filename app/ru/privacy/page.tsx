  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-24 text-rice-soft">
      ...
      <div className="space-y-5 text-sm leading-relaxed">
        ...
        <p>Мы не используем рекламные трекеры и не устанавливаем cookies. Для агрегированного подсчёта просмотров используется Vercel Web Analytics — без cookies и без идентификации отдельных посетителей.</p>
