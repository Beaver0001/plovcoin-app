        ...
        <Group id="security" index={5} copy={copy}>
          <Card id="hacken-review" title={copy.audit.title} status={copy.audit.reportState} copy={copy}>
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-6">
              ...
              <p className="text-sm leading-relaxed text-rice">{copy.audit.scopeLine} В· <span className="inline-flex flex-wrap items-center gap-2 mt-1 sm:mt-0"><a href={official.hacken.reportUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 rounded px-2 py-0.5 text-xs font-mono text-fire bg-fire/10 border border-fire/20 hover:bg-fire/20 transition-colors">{copy.audit.reportLink} ↗</a><a href={official.hacken.projectUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 rounded px-2 py-0.5 text-xs font-mono text-fire bg-fire/10 border border-fire/20 hover:bg-fire/20 transition-colors">{copy.audit.projectLink} ↗</a></span></p>
            </div>
