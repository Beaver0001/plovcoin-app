...
- Preserve the historical FAQ `#alpha` anchor, quick selections and search aliases; the answer now describes public pool activation and separate PlovDrop terms.
- Keep tokenomics, fees, mint data and the dated Trading/PlovDrop status observations unchanged.

This copy update does not approve pool geometry, seed parameters, successor strategy documents or mainnet execution. MAINNET_GO=NO.
